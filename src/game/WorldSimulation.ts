...
export class WorldSimulation {
  ...
  tick(): void {
    ...
    const corrected = dispatcherBreakdown.setpoints
    ...
    // Update peakers with dispatcher setpoint
    if (toggles.peakers) {
      this._peakers.tick({
    ...
    // Calculate demand response curtailment fraction from dispatcher setpoint
